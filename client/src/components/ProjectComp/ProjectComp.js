  ...
  return (
    <div className="project-info">
      ...
      <p className="project-objectives mt-3">
        <b>Partners:</b> Jigme Namgyel Engineering College (JNEC-RUB), Royal
        University of Bhutan, BHUTAN and University of Innsbruck (UBIK), AUSTRIA
      </p>
      <p className="project-details">
        <i>
          <b>Project Duration: 1st February 2023 – 31st January 2026</b>
        </i>
      </p>
      <p className="project-objectives mt-3">
